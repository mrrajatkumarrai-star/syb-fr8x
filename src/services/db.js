...
const SEED_DATA = {
  ...
  users: [
    { id: 'u1', name: 'Super Admin', email: 'admin@freightos.com', role: 'Super Admin', status: 'Active' },
    { id: 'u2', name: 'Ravi Kumar', email: 'ravi@freightos.com', role: 'Operations', status: 'Active' },
    { id: 'u3', name: 'Priya Sharma', email: 'priya@freightos.com', role: 'Documentation', status: 'Active' },
    { id: 'u4', name: 'Arjun Finance', email: 'arjun@freightos.com', role: 'Finance', status: 'Active' }
  ],
  quotations: [
  ...
  customerUsers: [
    { id: 'cu1', companyName: 'Tata Motors Ltd', email: 'tata@cargopulse.com', password: 'password123', kycStatus: 'Approved', kycInfo: { gst: '27AAAAT1234C1Z1', pan: 'AAAAT1234C', address: 'Pimpri, Pune, MH', docName: 'business_license.pdf' }, handlerId: 'u2' },
    { id: 'cu2', companyName: 'Reliance Industries', email: 'reliance@cargopulse.com', password: 'password123', kycStatus: 'Approved', kycInfo: { gst: '24AAACR4321B1Z2', pan: 'AAACR4321B', address: 'Jamnagar, Gujarat', docName: 'gst_certificate.pdf' }, handlerId: 'u3' },
    { id: 'cu3', companyName: 'New Client Corp', email: 'new@cargopulse.com', password: 'password123', kycStatus: 'Pending', kycInfo: { gst: '27AAACN5555X1Z9', pan: 'AAACN5555X', address: 'Bandra, Mumbai', docName: 'incorporation_cert.pdf' }, handlerId: '' }
  ],
  customerRequests: [

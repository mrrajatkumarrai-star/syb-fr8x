        ...
        <div class="modal" style="width: 460px;">
          ...
          <form id="user-form" onsubmit="event.preventDefault()">
            ...
            <div class="fg" style="margin-bottom:16px;">
              <label>Console Passcode (Numeric)</label>
              <input id="f-passcode" type="password" placeholder="${editData ? 'Leave blank to preserve' : 'Code to access console'}" ${editData ? '' : 'required'}/>
            </div>

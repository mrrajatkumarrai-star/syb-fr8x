      ...
      <div class="grid2" style="gap:20px; align-items: start;">
        <div class="card" style="margin-bottom:0">
          ...
          <form id="settings-form" onsubmit="event.preventDefault()">
            ...
            <div class="form-row">
              <div class="fg"><label>GSTIN (Company)</label><input id="s-gst" value="${s.gst || ''}" placeholder="27AAAAA0000A1Z5" maxlength="15"/></div>
              <div class="fg"><label>Country</label><input id="s-country" value="${s.country || 'India'}" required placeholder="India"/></div>
            </div>

            <div class="form-row">
              <div class="fg"><label>State</label><input id="s-companyState" value="${s.companyState || ''}" placeholder="Maharashtra"/></div>
              <div class="fg"><label>State Code (2-digit GST)</label><input id="s-companyStateCode" value="${s.companyStateCode || ''}" maxlength="2" placeholder="27"/></div>
            </div>
            ...
            <div class="form-row" style="margin-top:4px">
              <div class="fg">
                ...
                <input id="s-invPrefix" value="${s.invoicePrefix || 'INV'}" maxlength="10" placeholder="INV"/>
              </div>
              <div class="fg">
                <label>Default Place of Supply (State Code)</label>
                <input id="s-placeOfSupply" value="${s.defaultPlaceOfSupply || s.companyStateCode || ''}" maxlength="2" placeholder="27"/>
              </div>
            </div>
      ...
      if (form) {
        form.onsubmit = async (e) => {
          ...
          const updatedSettings = {
            ...
            companyState: fv('s-companyState'),
            companyStateCode: fv('s-companyStateCode'),
            address: fv('s-address'),
            phone: fv('s-phone'),
            email: fv('s-email'),
            currency: fv('s-currency'),
            jobPrefix: fv('s-prefix'),
            invoicePrefix: fv('s-invPrefix') || 'INV',
            defaultPlaceOfSupply: fv('s-placeOfSupply'),

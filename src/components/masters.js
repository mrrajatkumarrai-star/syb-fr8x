  ...
  openFormModal(editData, container) {
    ...
    if (this.type === 'customers') {
      formHTML = `
        ...
        <div class="form-row">
          <div class="fg"><label>GST / GSTIN</label><input id="f-gst" value="${editData ? editData.gst || '' : ''}" placeholder="27AAAAA0000A1Z5" maxlength="15"/></div>
        ...
        <div class="form-row">
          <div class="fg"><label>Billing State</label><input id="f-billingState" value="${editData ? editData.billingState || '' : ''}" placeholder="Maharashtra"/></div>
          <div class="fg"><label>State Code (2-digit GST)</label><input id="f-billingStateCode" value="${editData ? editData.billingStateCode || '' : ''}" maxlength="2" placeholder="27"/></div>
        </div>
        <div class="form-row">
      ...
      document.getElementById("master-form").onsubmit = async (e) => {
        ...
        if (this.type === 'customers') {
          d = {
            ...
            gst: fv('f-gst'),
            billingState: fv('f-billingState'),
            billingStateCode: fv('f-billingStateCode'),

    ...
    return `
      <div style="display: flex; flex-direction: column; gap: 12px; text-align: left;">
        ...
        <div style="margin-top:12px; text-align:center;">
          <a href="/syb-fr8x" target="_blank" style="color:#a855f7; font-size:11px !important; font-weight:600; text-decoration:none; display:inline-flex; align-items:center; gap:4px;">
